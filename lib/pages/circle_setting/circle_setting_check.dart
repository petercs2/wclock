import 'package:circle_clock/pages/circle_query/circle_query_logic.dart';
...
import '../circle_query/circle_query_logic.dart';

class CircleSettingCheck extends GetView<CircleQueryLogic> {
  const CircleSettingCheck({super.key});
